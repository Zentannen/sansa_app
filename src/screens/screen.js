...
import {Menu,Close,Notifications,BlurOn,Flare,Book} from '@material-ui/icons'
        ...
        <div className={classes.root}>
            <AppBar>
                ...
                <Toolbar className={classes.toolbar}>
                    ...
                    <IconButton onClick={()=>changeScreen(3)} color="secondary">
            ...
            <Dialog 
                ...
                keepMounted
                >
                <div className={classes.root} style={{backgroundColor:theme.theme?'#00000050':'#eee'}}>
                    <Paper elevation={0} square>
                    ...
                    <div style={{width:'90vw',margin:'5vh 10vw'}}>
                        ...
                        <Paper style={{width:'80vw',minHeight:'20vh',padding:'2vh 2vw',margin:'1vh 0'}}>
